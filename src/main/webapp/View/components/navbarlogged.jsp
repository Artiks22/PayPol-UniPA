...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    ...
    <div class="links" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
<%--          <a class="btn btn-primary btn-sm px-5  me-sm-3 fs-6 fw-bolder" href="../loginpage.jsp">Accedi</a>--%>
<%--          <a class="nav-link active" aria-current="page" href="../loginpage.jsp">Accedi</a>--%>
        </li>
        <li class="nav-item">
          <a id ="registrazione" class="btn btn-outline-dark btn-sm px-5  fs-6 fw-bolder" href="${pageContext.request.contextPath}/AuthenticationManager/logout">Logout</a>
